...
namespace WeaponDoc.Models
{
    ...
    public partial class GunSudexDbContext : DbContext
    {
        public GunSudexDbContext()
            : base("name=GunSudexDbContext")
        {
        }
        ...
        public virtual DbSet<CalcDetail> CalcDetails { get; set; }
        ...
        public virtual DbSet<JudicialStatus> JudicialStatuses { get; set; }
